...
export const Layout: React.FC<{
  ...
  return (
    <div className="mx-auto grid grid-cols-9 pt-0 md:container md:pt-0">
      <div
        ref={stickyRef}
        className="group peer sticky top-0 z-20 col-span-9 flex flex-col justify-end md:col-span-2 md:h-screen md:flex-row md:justify-start md:gap-4 md:px-6 md:py-0"
      >
        <Menu menuItems={menuItems} />
        <header className="flex flex-col justify-between bg-white px-6 py-2 shadow-sm md:items-center md:overflow-visible md:bg-transparent md:px-0 md:py-6 md:shadow-none dark:bg-black dark:shadow-black">
      ...
      <main className="prose prose-xl dark:prose-invert relative col-span-9 max-w-fit px-6 pt-6 md:col-span-6 md:px-0 md:pt-24 lg:col-span-5">
