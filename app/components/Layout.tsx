  ...
  return (
    <div className="mx-auto grid grid-cols-9 pt-0 md:container">
      ...
      >
        ...
        <header className="flex flex-col justify-between bg-white px-6 py-2 md:items-center md:overflow-visible md:bg-transparent md:px-0 md:py-6 dark:bg-black dark:md:bg-transparent">
      ...
      <main className="prose prose-xl dark:prose-invert relative col-span-9 max-w-fit px-6 pt-6 peer-[.sticky]:top-[24px] md:col-span-6 md:px-0 md:pt-24 lg:col-span-5">
